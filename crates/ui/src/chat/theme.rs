...
pub(crate) static THEME: ThemeColors = ThemeColors {
    ...
    diff_del_bg: Color32::from_rgb(38, 24, 31),
    diff_add_bg: Color32::from_rgb(20, 35, 31),
    diff_word_del_bg: Color32::from_rgb(73, 34, 38),
    diff_word_add_bg: Color32::from_rgb(27, 60, 40),
