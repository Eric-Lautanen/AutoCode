...
pub fn tool_definitions() -> serde_json::Value {
    ...
    serde_json::json!([
        ...
        {"type":"function","function":{"name":"project_tree","strict":true,"description":"Recursively list project tree (all files/dirs). Returns relative paths, one per line, dirs with trailing /. Skips hidden and gitignored files. Use once to understand project structure.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Root dir (default: project root)."}},"required":[],"additionalProperties":false}}},
