...
pub fn tool_definitions() -> serde_json::Value {
    ...
    serde_json::json!([
        ...
        {"type":"function","function":{"name":"todo_list","strict":true,"description":"Track multi-step tasks for the current session. Send full list on every update.","parameters":{"type":"object","properties":{"title":{"type":"string","description":"Short title (max 35 chars)."},"items":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string","description":"Stable id e.g. '1'."},"content":{"type":"string","description":"Task description."},"status":{"type":"string","enum":["pending","in_progress","completed","cancelled"],"description":"Status."},"priority":{"type":"string","enum":["high","medium","low"],"description":"Priority (default medium)."}},"required":["id","content","status"],"additionalProperties":false},"description":"All items."}},"required":["title","items"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"project_task_list","strict":true,"description":"Track project-level tasks that persist across sessions. Use for long-running goals. Send full list on every update.","parameters":{"type":"object","properties":{"title":{"type":"string","description":"Short title (max 35 chars)."},"items":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string","description":"Stable id e.g. '1'."},"content":{"type":"string","description":"Task description."},"status":{"type":"string","enum":["pending","in_progress","completed","cancelled"],"description":"Status."},"priority":{"type":"string","enum":["high","medium","low"],"description":"Priority (default medium)."}},"required":["id","content","status"],"additionalProperties":false},"description":"All items."}},"required":["title","items"],"additionalProperties":false}}},
