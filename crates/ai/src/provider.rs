...
pub fn tool_definitions(strict: bool) -> serde_json::Value {
    ...
    serde_json::json!([
        {"type":"function","function":{"name":"run_shell","strict":strict,"description":shell_desc,"parameters":{"type":"object","properties":{"command":{"type":"string","description":"Shell command."},"cwd":{"type":"string","description":"Working dir (default: project root)."},"timeout_secs":{"type":"integer","description":"Timeout secs (default 300, max 600)."}},"required":["command"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"read_file","strict":strict,"description":"Read a file. Numbered lines, line/byte totals. Use offset+limit for large files. For multi-file use read_files.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"File path."},"offset":{"type":"integer","description":"Start line (1-based, default 1)."},"limit":{"type":"integer","description":"Max lines (default 2000). Read at least 50 lines per call."}},"required":["path"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"read_files","strict":strict,"description":"Read multiple files at once (max 10). Use instead of repeated read_file.","parameters":{"type":"object","properties":{"paths":{"type":"array","items":{"type":"string"},"description":"File paths (max 10)."}},"required":["paths"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"read_entire_file","strict":strict,"description":"Read entire file without truncation. Use sparingly -- only when patch_file fails or you need absolute certainty about content.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"File path."},"entire":{"type":"boolean","description":"Must be true to use this tool."}},"required":["path","entire"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"write_file","strict":strict,"description":"Write/overwrite a file. Creates parent dirs. For small edits prefer patch_file.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"File path."},"content":{"type":"string","description":"Full file content."}},"required":["path","content"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"list_dir","strict":strict,"description":"List directory contents. Trailing / for dirs. Respects .gitignore.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Dir path (default: project root)."}},"required":["path"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"project_tree","strict":strict,"description":"Recursively list project tree (all files/dirs). Returns relative paths, one per line, dirs with trailing /. Skips hidden and gitignored files. Use once to understand project structure.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Root dir (default: project root)."}},"required":[],"additionalProperties":false}}},
        {"type":"function","function":{"name":"delete_file","strict":strict,"description":"Delete a file or empty directory. Irreversible.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Path to delete."}},"required":["path"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"rename_file","strict":strict,"description":"Move/rename file or directory. Creates dest parent dirs.","parameters":{"type":"object","properties":{"from":{"type":"string","description":"Source path. Must exist."},"to":{"type":"string","description":"Destination path."}},"required":["from","to"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"create_dir","strict":strict,"description":"Create directory tree (mkdir -p). No-op if exists.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Directory to create."}},"required":["path"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"grep","strict":strict,"description":grep_desc,"parameters":{"type":"object","properties":{"pattern":{"type":"string","description":"Search pattern (literal by default; use ^ or $ for regex)."},"path":{"type":"string","description":"Dir/file to search (default: project root)."},"file_glob":{"type":"string","description":"Glob filter e.g. '*.rs'."},"case_sensitive":{"type":"boolean","description":"Case sensitive? (default true)."},"max_results":{"type":"integer","description":"Max matches (default 50, max 200)."}},"required":["pattern"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"patch_file","strict":strict,"description":"Surgical find-and-replace edit. Fuzzy-matches similar lines, handles CRLF/tab differences. Fails on ambiguous match. For multi-line edits prefer patch_lines.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"File to patch."},"old_text":{"type":"string","description":"Text to replace (copy exact lines from read_file, numbers auto-stripped)."},"new_text":{"type":"string","description":"Replacement text. Empty to delete."},"replace_all":{"type":"boolean","description":"Replace all occurrences (default: first only)."}},"required":["path","old_text","new_text"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"patch_lines","strict":strict,"description":"Replace a range of lines by line number. Use read_file first to see numbered lines. Faster and more reliable than patch_file for multi-line edits.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"File to patch."},"start_line":{"type":"integer","description":"First line to replace (1-based, inclusive)."},"end_line":{"type":"integer","description":"Last line to replace (1-based, inclusive)."},"new_text":{"type":"string","description":"Replacement text."}},"required":["path","start_line","end_line","new_text"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"web_search","strict":strict,"description":"Search the web. Returns summary text + URLs. Use fetch_url to read pages.","parameters":{"type":"object","properties":{"query":{"type":"string","description":"Search query. Be specific."},"num_results":{"type":"integer","description":"Results to return (1-10, default 5)."}},"required":["query"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"fetch_url","strict":strict,"description":"Fetch URL text content. HTML auto-stripped.","parameters":{"type":"object","properties":{"url":{"type":"string","description":"Full URL."},"max_bytes":{"type":"integer","description":"Max bytes (default 32768, max 131072)."}},"required":["url"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"todo_list","strict":strict,"description":"Track multi-step tasks for the current session. Send full list on every update.","parameters":{"type":"object","properties":{"title":{"type":"string","description":"Short title (max 35 chars)."},"task_items":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string","description":"Stable id e.g. '1'."},"content":{"type":"string","description":"Task description."},"status":{"type":"string","enum":["pending","in_progress","completed","cancelled"],"description":"Status."},"priority":{"type":"string","enum":["high","medium","low"],"description":"Priority (default medium)."}},"required":["id","content","status"],"additionalProperties":false},"description":"All items."}},"required":["title","task_items"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"project_task_list","strict":strict,"description":"Track project-level tasks that persist across sessions. Use for long-running goals. Send full list on every update.","parameters":{"type":"object","properties":{"title":{"type":"string","description":"Short title (max 35 chars)."},"task_items":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string","description":"Stable id e.g. '1'."},"content":{"type":"string","description":"Task description."},"status":{"type":"string","enum":["pending","in_progress","completed","cancelled"],"description":"Status."},"priority":{"type":"string","enum":["high","medium","low"],"description":"Priority (default medium)."}},"required":["id","content","status"],"additionalProperties":false},"description":"All items."}},"required":["title","task_items"],"additionalProperties":false}}},
        ...
        {"type":"function","function":{"name":"get_skill","strict":strict,"description":"Retrieve best-practice guidance or notes for a topic (e.g. 'rust error handling', 'egui migration'). Scans skills/ for .md files and matches your keyword against filenames and file headings. Call before working in an unfamiliar area.","parameters":{"type":"object","properties":{"keyword":{"type":"string","description":"Topic or phrase to search for (matched against filenames and file content headings)."}},"required":["keyword"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"handoff","strict":strict,"description":"End session and start a fresh one. next_prompt becomes the first user message in the new session.","parameters":{"type":"object","properties":{"reason":{"type":"string","description":"Why handoff is needed."},"next_prompt":{"type":"string","description":"Full instructions for the next session on what to continue working on."}},"required":["reason","next_prompt"],"additionalProperties":false}}},
        {"type":"function","function":{"name":"name_session","strict":strict,"description":"Set a descriptive label for this session. Call first in every session.","parameters":{"type":"object","properties":{"name":{"type":"string","description":"Short name e.g. 'fixing_build'."}},"required":["name"],"additionalProperties":false}}},
    ])
}
...
fn build_request_body(
    ...
    if req.tools {
        body.tools = Some(tool_definitions(supports_strict));
