...
pub fn tool_definitions(strict: bool) -> serde_json::Value {
    ...
    serde_json::json!([
        ...
        {"type":"function","function":{"name":"read_files","strict":strict,"description":"Read multiple files at once (max 10). Shows numbered lines per file. Use instead of repeated read_file.","parameters":{"type":"object","properties":{"paths":{"type":"array","items":{"type":"string"},"description":"File paths (max 10)."}},"required":["paths"],"additionalProperties":false}}},
