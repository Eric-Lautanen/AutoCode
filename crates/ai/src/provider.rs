...
pub fn tool_definitions(strict: bool, handoff_enabled: bool) -> serde_json::Value {
    ...
    let mut tools: Vec<serde_json::Value> = vec![
        ...
        serde_json::json!({"type":"function","function":{"name":"list_dir","strict":strict,"description":"List directory contents. Trailing / for dirs. Respects .gitignore.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Dir path (default: project root)."}},"required":["path"],"additionalProperties":false}}}),
        ...
        serde_json::json!({"type":"function","function":{"name":"delete_file","strict":strict,"description":"Delete a file or empty directory. Irreversible.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Path to delete."}},"required":["path"],"additionalProperties":false}}}),
        serde_json::json!({"type":"function","function":{"name":"rename_file","strict":strict,"description":"Move/rename file or directory. Creates dest parent dirs.","parameters":{"type":"object","properties":{"from":{"type":"string","description":"Source path. Must exist."},"to":{"type":"string","description":"Destination path."}},"required":["from","to"],"additionalProperties":false}}}),
        serde_json::json!({"type":"function","function":{"name":"create_dir","strict":strict,"description":"Create directory tree (mkdir -p). No-op if exists.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Directory to create."}},"required":["path"],"additionalProperties":false}}}),
