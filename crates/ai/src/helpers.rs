...
pub fn parse_todo_items(args: &serde_json::Value, default_title: &str) -> Option<(String, Vec<TodoItem>)> {
...
pub fn parse_project_task_from_tool_args(args: &serde_json::Value) -> Option<(String, Vec<TodoItem>)> {
